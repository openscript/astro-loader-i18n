...
import { i18nInfileSchema, i18nLoader } from "astro-loader-i18n";
...
const infileCollection = defineCollection({
  ...
  schema: i18nInfileSchema(z.array(z.object({ path: z.string(), title: z.string() })), astroConfig.i18n!.locales),
});
